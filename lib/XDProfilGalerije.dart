...
class XDProfilGalerije extends StatelessWidget {
  XDProfilGalerije({
    Key? key,
  }) : super(key: key);
  @override
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Pinned.fromPins(
                  Pin(size: 122.3, start: 17.4),
                  Pin(size: 17.0, end: 13.8),
                  child: Text(
                    'Galerija hrane i pica',
                    style: TextStyle(
                      fontFamily: 'Roboto',
                      fontSize: 12,
                ...
                Pinned.fromPins(
                  Pin(size: 194.3, start: 17.4),
                  Pin(size: 21.0, end: 30.8),
                  child: Text(
