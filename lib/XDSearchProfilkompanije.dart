...
class XDSearchProfilkompanije extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 31.0, end: 31.7),
            Pin(size: 111.3, middle: 0.6273),
            child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 16.8, start: 27.2),
            Pin(size: 14.0, start: 61.0),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 12.1, middle: 0.768),
            Pin(size: 12.1, middle: 0.3617),
            child:
                // Adobe XD layer: 'facebook' (component)
                XDfacebook(),
          ),
          Pinned.fromPins(
            Pin(size: 12.1, middle: 0.8224),
            Pin(size: 12.1, middle: 0.3617),
            child:
...
const String _svg_7ai01e =
    '<svg viewBox="-4.2 385.5 379.7 1.0" ><path transform="translate(-4.17, 385.5)" d="M 0 0 L 379.6694030761719 0" fill="none" stroke="#a5aab5" stroke-width="0.5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_ytxya5 =
    '<svg viewBox="145.5 252.0 1.0 62.0" ><path transform="translate(145.5, 252.0)" d="M 0 0 L 0 62" fill="none" stroke="#b7b5b5" stroke-width="0.20000000298023224" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_12kqzx =
    '<svg viewBox="238.5 254.5 1.0 62.0" ><path transform="translate(238.5, 254.47)" d="M 0 0 L 0 62" fill="none" stroke="#b7b5b5" stroke-width="0.20000000298023224" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_et4vqx =
    '<svg viewBox="27.2 61.0 16.8 14.0" ><path transform="matrix(-1.0, 0.0, 0.0, -1.0, 52.0, 87.0)" d="M 18.28858184814453 12.19366073608398 C 18.00876998901367 11.92715644836426 17.56506729125977 11.93766403198242 17.29856109619141 12.21782493591309 C 17.03170585632324 12.49798583984375 17.04291534423828 12.94134140014648 17.32272529602051 13.20819664001465 L 22.69552230834961 18.30398178100586 L 8.700403213500977 18.30398178100586 C 8.31378173828125 18.30398178100586 8 18.61776351928711 8 19.00438690185547 C 8 19.39101028442383 8.31378173828125 19.70479202270508 8.700403213500977 19.70479202270508 L 22.6731071472168 19.70479202270508 L 17.32272338867188 24.80093002319336 C 17.04256248474121 25.06778335571289 17.03170585632324 25.51113891601563 17.29856109619141 25.79130172729492 C 17.43618965148926 25.93558311462402 17.6207447052002 26.00842475891113 17.8056526184082 26.00842475891113 C 17.9793529510498 26.00842475891113 18.15305328369141 25.94433975219727 18.28858184814453 25.81511497497559 L 24.39925575256348 19.99476051330566 C 24.66400909423828 19.73035621643066 24.8096923828125 19.37875366210938 24.8096923828125 19.0043888092041 C 24.8096923828125 18.6300220489502 24.66400909423828 18.27841949462891 24.38699722290039 18.00210952758789 L 18.28858184814453 12.19366073608398 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
