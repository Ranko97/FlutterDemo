...
class XDNovaobjava extends StatelessWidget {
  XDNovaobjava({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 65.0, start: 36.0),
            Pin(size: 16.0, middle: 0.5377),
            child:
                // Adobe XD layer: '2 Hr ago' (text)
                Text(
              'Unesite URL',
          ...
          Pinned.fromPins(
            Pin(size: 16.3, middle: 0.5019),
            Pin(size: 16.3, middle: 0.3783),
            child:
...
const String _svg_gvm2ny =
    '<svg viewBox="36.0 460.5 303.0 1.0" ><path transform="translate(36.0, 460.5)" d="M 0 0 L 303 0" fill="none" stroke="#b7b5b5" stroke-width="0.5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_jiyav2 =
    '<svg viewBox="36.0 522.0 303.0 1.0" ><path transform="translate(36.0, 521.98)" d="M 0 0 L 303 0" fill="none" stroke="#b7b5b5" stroke-width="0.5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
