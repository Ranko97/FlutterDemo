...
class XDProfilRecenzije extends StatelessWidget {
  XDProfilRecenzije({
    Key? key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 23.8, end: 23.8),
            Pin(size: 129.2, middle: 0.5272),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        Pin(size: 104.0, middle: 0.2506),
                        Pin(size: 19.0, middle: 0.2178),
                        child:
                      ...
                      Pinned.fromPins(
                        Pin(size: 15.0, middle: 0.7553),
                        Pin(size: 16.0, middle: 0.2209),
                        child:
                      ...
                      Pinned.fromPins(
                        Pin(size: 194.3, start: 18.4),
                        Pin(size: 21.0, middle: 0.5934),
                        child: Text(
                          'Naslov recenzije',
                          style: TextStyle(
                            fontFamily: 'Roboto',
                      ...
                      Pinned.fromPins(
                        Pin(start: 18.4, end: 20.0),
                        Pin(size: 21.0, middle: 0.7967),
                        child: Text(
                      ...
                      Pinned.fromPins(
                        Pin(size: 50.3, end: 21.1),
                        Pin(size: 10.8, middle: 0.2533),
                        child: Stack(
                          children: <Widget>[
                            Pinned.fromPins(
                ...
                Pinned.fromPins(
                  Pin(size: 32.7, start: 16.0),
                  Pin(size: 32.7, start: 17.9),
                  child: Stack(
                    children: <Widget>[
                      Pinned.fromPins(
                        Pin(start: 0.0, end: 0.0),
